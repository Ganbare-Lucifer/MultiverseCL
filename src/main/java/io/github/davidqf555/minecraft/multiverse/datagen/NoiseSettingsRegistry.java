...
public final class NoiseSettingsRegistry {
    ...
    static {
        List<Pair<String, SettingsValue>> shapes = List.of(
                ...
                Pair.of("flooded/normal", new SettingsValue(true, false, false, NoiseSettings.create(-64, 384, new NoiseSamplingSettings(1, 1, 80, 160), new NoiseSlider(-0.078125D, 2, 8), new NoiseSlider(0.1171875, 3, 0), 1, 2, TerrainProvider.overworld(false)), noise -> NoiseRouterData.overworldWithNewCaves(noise, false))),
                Pair.of("flooded/amplified", new SettingsValue(true, false, false, NoiseSettings.create(-64, 384, new NoiseSamplingSettings(1, 1, 80, 160), new NoiseSlider(-0.078125, 2, 0), new NoiseSlider(0.4, 3, 0), 1, 2, TerrainProvider.overworld(true)), noise -> NoiseRouterData.overworldWithNewCaves(noise, false))),
                Pair.of("flooded/mountains", new SettingsValue(true, false, false, NoiseSettings.create(-64, 384, new NoiseSamplingSettings(1, 1, 80, 160), new NoiseSlider(-0.078125D, 2, 0), new NoiseSlider(0.4, 3, 0), 1, 2, MultiverseTerrainShapers.mountains()), noise -> NoiseRouterData.overworldWithNewCaves(noise, false))),
                ...
                Pair.of("noodles", new SettingsValue(false, false, false, NoiseSettings.create(0, 256, new NoiseSamplingSettings(2, 1, 80, 160), new NoiseSlider(-23.4375, 64, -46), new NoiseSlider(-0.234375, 7, 1), 2, 1, TerrainProvider.floatingIslands()), noise -> MultiverseNoiseRouters.noodles(noise, 0, 256))),
                Pair.of("blobs", new SettingsValue(false, false, false, NoiseSettings.create(0, 256, new NoiseSamplingSettings(2, 1, 80, 160), new NoiseSlider(-23.4375, 64, -46), new NoiseSlider(-0.234375, 7, 1), 2, 1, TerrainProvider.floatingIslands()), noise -> MultiverseNoiseRouters.blobs(noise, 0, 256)))
        );
