...
public final class BlockRegistry {
    ...
    public static final RegistryObject<RiftBlock> RIFT = register("rift", () -> new RiftBlock(BlockBehaviour.Properties.of(Material.PORTAL).strength(-1, 3600000).noLootTable().noParticlesOnBreak().lightLevel(state -> 15)));
